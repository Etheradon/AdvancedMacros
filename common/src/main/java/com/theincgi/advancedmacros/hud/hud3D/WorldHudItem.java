...
public abstract class WorldHudItem implements Destroyable {
    ...
    /**
     * should call to {@link #disableDraw()} and to make all functions un-usable as it is no longer
     * in use
     */
    @Override
    public void destroy() {
     ...
     *
     * @see<br> {@link #disableDraw()}<br> {@link #isDrawing()}
     */
    public void enableDraw() {
        ...
        isDrawing = true;
        AdvancedMacros.EVENT_HANDLER.addWorldHudItem(this);
    }

    /**
     * basicly removes it from the list of stuff to draw<br>
     *
     * @see {@link #enableDraw()}<br> {@link #isDrawing()}
     */
    public void disableDraw() {
        isDrawing = false;
        AdvancedMacros.EVENT_HANDLER.removeWorldHudItem(this);
    }
